	...
	<div class="navbar navbar-default header-highlight">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<div class="navbar-right">
				<p class="navbar-text">Morning, Agus!</p>
					...
					<div class="sidebar-user-material">
						<div class="category-content">
							<div class="sidebar-user-material-content">
								...
								<h6>Agus Seputra</h6>
								<span class="text-size-small">Unidiksha</span>
							</div>
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li>
									<a href="#"><i class="icon-stack2"></i> <span>Manajemen Produk</span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-copy"></i> <span>Manajemen User</span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-droplet2"></i> <span>Manajemen Komoditas</span></a>
									<ul>
								...
								<li>
									<a href="#"><i class="icon-stack"></i> <span>Manajemen PPL</span></a>
									<ul>
